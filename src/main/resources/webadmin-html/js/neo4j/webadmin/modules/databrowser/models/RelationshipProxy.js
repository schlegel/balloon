(function() {
  ...
  */
  ...
  define(['./PropertyContainer'], function(PropertyContainer) {
    ...
    return RelationshipProxy = (function() {
      ...
      function RelationshipProxy() {
        ...
        this.getEndId = __bind(this.getEndId, this);
        RelationshipProxy.__super__.constructor.apply(this, arguments);
      }
