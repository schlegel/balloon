(function() {
  ...
  */
  ...
  define(['neo4j/webadmin/utils/ItemUrlResolver', 'neo4j/webadmin/modules/databrowser/models/DataBrowserState', './createRelationship', 'ribcage/View', 'neo4j/webadmin/utils/FormHelper', 'lib/amd/jQuery'], function(ItemUrlResolver, DataBrowserState, template, View, FormHelper, $) {
    ...
    return CreateRelationshipDialog = (function() {
      ...
      function CreateRelationshipDialog() {
        ...
        CreateRelationshipDialog.__super__.constructor.apply(this, arguments);
      }
      ...
      CreateRelationshipDialog.prototype.initialize = function(opts) {
        ...
        if (this.dataModel.getState() === DataBrowserState.State.SINGLE_NODE) {
      ...
      CreateRelationshipDialog.prototype.saveSuccessful = function(relationship) {
        ...
        this.dataModel.setQuery("rel:" + id);
        this.dataModel.executeCurrentQuery();
